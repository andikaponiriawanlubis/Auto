...
const thumbnailUrl = "https://i.ibb.co/WNZDSM1S/2168eaa046b3.jpg";
...
bot.command("delaysw", checkWhatsAppConnection, checkPremium, checkCooldown, async (ctx) => {
  ...
  const processMessage = await ctx.telegram.sendPhoto(ctx.chat.id, "https://i.ibb.co/qYTg2gkG/a99e41ddd112.jpg", {
    caption: `
...
// Function Bug
async function DelayBebasSpamPart1(target) {
